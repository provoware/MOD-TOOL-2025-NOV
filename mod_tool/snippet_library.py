...
class SnippetLibraryPanel(ttk.LabelFrame):
    ...
    def _build_creator(self) -> None:
        ...
        self.new_content = tk.Text(frame, height=4, wrap="word")
        ...
        self.new_content.grid(row=1, column=1, sticky="ew", padx=(4, 0), pady=(4, 0))
    ...
    def _build_list(self) -> None:
        ...
        self.tree = ttk.Treeview(list_frame, columns=("name", "aktualisiert"), show="headings")
    ...
    def _build_detail(self) -> None:
        ...
        self.detail_content = tk.Text(frame, height=6, wrap="word")
        ttk.Label(frame, text="Name").grid(row=0, column=0, sticky="w")
        ttk.Entry(frame, textvariable=self.detail_name).grid(row=0, column=1, sticky="ew", padx=(4, 0))
        ttk.Label(frame, text="Inhalt").grid(row=1, column=0, sticky="nw", pady=(4, 0))
        self.detail_content.grid(row=1, column=1, sticky="ew", padx=(4, 0), pady=(4, 0))
